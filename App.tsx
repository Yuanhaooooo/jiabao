    ...
    <div className="fixed top-1/2 left-12 -translate-y-1/2 w-80 h-[480px] border border-yellow-500/30 bg-black/80 backdrop-blur-xl p-1 pointer-events-auto animate-in fade-in slide-in-from-left-10 duration-500 flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.5)] z-50">
      <div className="relative flex-1 overflow-hidden group border border-yellow-500/10">
        ...
        <div className="absolute top-2 right-2 flex flex-col items-end gap-1">
           <div className="text-[6px] text-yellow-500/20 font-mono">FRM_SYNC: 24.0</div>
           <div className="text-[6px] text-yellow-500/20 font-mono">LAT: 0.002ms</div>
        </div>
                ...
                {state === 'GIFT_OPEN' && (
                  <>
                    ...
                    <button 
                      ...
                      className={`w-12 h-12 border border-yellow-500/30 flex items-center justify-center transition-all bg-black/40 ${isArchiveOpen ? 'bg-yellow-500/20 shadow-[0_0_15px_rgba(202,138,4,0.4)] border-yellow-500' : 'hover:bg-white/10'}`}
                      title="语音存档"
                    >
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-yellow-500">
        ...
        <div className="max-w-4xl w-full text-center">
          ...
          {state === 'CANDLES_LIT' && (
            <div className="animate-in fade-in duration-1000 flex flex-col items-center">
              ...
              <p className="text-yellow-500/80 uppercase tracking-[0.6em] text-[11px] animate-bounce bg-yellow-500/10 px-6 py-2 rounded-full border border-yellow-500/20 font-mono">再次吹气 · 完成升维契约</p>
            </div>
          )}
