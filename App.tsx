        ...
        <div className="max-w-4xl w-full text-center">
          ...
          {state === 'CANDLES_LIT' && (
            <div className="animate-in fade-in duration-1000 flex flex-col items-center">
              ...
              <p className="text-yellow-500/80 uppercase tracking-[0.6em] text-[11px] animate-bounce bg-yellow-500/10 px-6 py-2 rounded-full border border-yellow-500/20 font-mono">
                再次吹气 · 完成升维契约
              </p>
            </div>
          )}
